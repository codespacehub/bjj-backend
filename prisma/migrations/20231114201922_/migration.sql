...
INSERT INTO "new_Time" ("created_at", "hour", "id", "modality_id", "organization_id", "updated_at", "user_id") SELECT "created_at", "hour", "id", "modality_id", "organization_id", "updated_at", "user_id" FROM "Time";
DROP TABLE "Time";
