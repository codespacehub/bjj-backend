/*
  ...
  - You are about to drop the column `degree` on the `users` table. All the data in the column will be lost.
...
INSERT INTO "new_users" ("active", "amount_class", "birth_date", "cep", "city", "cpf", "created_at", "district", "email", "graduation_id", "house_number", "id", "modality_id", "name", "organization_id", "password", "payday", "phone", "plan", "plan_id", "role", "street", "uf", "updated_at", "verified") SELECT "active", "amount_class", "birth_date", "cep", "city", "cpf", "created_at", "district", "email", "graduation_id", "house_number", "id", "modality_id", "name", "organization_id", "password", "payday", "phone", "plan", "plan_id", "role", "street", "uf", "updated_at", "verified" FROM "users";
DROP TABLE "users";
